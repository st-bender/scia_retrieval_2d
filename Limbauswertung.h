...
int Limb_Auswertung(Orbitliste Orbitlist,
					...
					std::vector<Ausgewertete_Messung_Limb> &Ausgewertete_Limbmessung_MgI,
					std::vector<Ausgewertete_Messung_Limb> &Ausgewertete_Limbmessung_MgII,
					std::vector<Ausgewertete_Messung_Limb> &Ausgewertete_Limbmessung_unknown,
					std::vector<Ausgewertete_Messung_Limb> &Ausgewertete_Limbmessung_FeI,
					Konfiguration &Konf);
