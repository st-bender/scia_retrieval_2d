...
#define DATEI_IO_HH_
// Einlesen
// Alte Ascii einlesefunktionen......// später löschen... sind im Feuerballprojekt viel besser
//vector<Messung_Limb> ReadL1C_Limb(string Dateiname);
//Messung_Nadir* ReadL1C_Nadir(string Dateiname, int& Anzahl_Messungen);  //Besser ein dynamisches Array einlesen, schneller als Vektor
// EINLESEN DER BINÄREN DATEN/////////////////////////////////////////////////
// Beide Funktionen sehen aus entwicklungsgeschichtlichen Gründen unterschiedlich aus (vektor vs array)
// zeittechnisch ist die nadirvariante günstiger...kann später mal gefixt werden...erstmal programm fertig kriegen
...
Messung_Nadir *ReadL1C_Nadir_mpl_binary(string Dateiname, int &Anzahl_Messungen);  //Besser ein dynamisches Array einlesen, schneller als Vektor
///////////////////////////////////////////////////////////////////////////////////////////////////////
int Ausgabe_Saeulendichten(string Dateiname, vector<Ausgewertete_Messung_Limb> A_Messung_L);
int Ausgabe_Saeulendichten(string Dateiname, vector<Ausgewertete_Messung_Nadir> A_Messung_N); //funktion ist ja überladbar
